...
func (m *MongoDBDriver) InsertAdmin(admin *models.Admin) error {
...
func (m *MongoDBDriver) FindAdminByID(id string) (*models.Admin, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
	...
	if err != nil {
		if errors.Is(err, mongo.ErrNoDocuments) {
			return nil, nil // models.Admin not found
		}
...
func (m *MongoDBDriver) InsertBook(book *models.Book) error {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
...
func (m *MongoDBDriver) FindBookByID(id string) (*models.Book, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
	...
	if err != nil {
		if errors.Is(err, mongo.ErrNoDocuments) {
			return nil, nil // models.Book not found
		}
...
func (m *MongoDBDriver) InsertStudent(student *models.Student) error {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
...
func (m *MongoDBDriver) FindStudentByID(id string) (*models.Student, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
	...
	if err != nil {
		if errors.Is(err, mongo.ErrNoDocuments) {
			return nil, nil // models.Student not found
		}
...
func (m *MongoDBDriver) InsertTransaction(transaction *models.Transaction) error {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
...
func (m *MongoDBDriver) FindTransactionsByStudentID(id string) ([]*models.Transaction, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
